...
function generatePortfolioHTML(portfolio) {
  ...
  let html = `
    <div style="padding: 40px; font-family: ${portfolio.font || "'Inter', sans-serif"}; line-height: 1.6; color: #333;">
  `;
  ...
  if (sections.hero) {
    html += `
      <div style="text-align: center; margin-bottom: 40px; border-bottom: 2px solid var(--primary); padding-bottom: 30px;">
        ...
        <p style="max-width: 600px; margin: 20px auto; font-size: 1.1em;">${sections.hero.bio || ''}</p>
      </div>
    `;
  }
