...
window.addEventListener("DOMContentLoaded", () => {
  ...
  if (path === "/login") showPage("login-page");
  else if (path === "/register") showPage("register-page");
  else if (path === "/builder") showPage("builder-page");
  else if (path === "/preview") showPage("preview-modal");
  else if (path === "/saved") showPage("saved-page");
  else if (path === "/my-portfolios") showPage("#my-portfolios");
  else showPage("login-page"); // default
});
